...
<svelte:head>
	<title>Créer un compte — Callback</title>
</svelte:head>
...
<div class="flex min-h-screen items-center justify-center bg-[#f7fbfa] px-6 py-12">
	<div class="w-full max-w-sm">
		...
		<div class="rounded-2xl border border-[#dde9e7] bg-white p-7 shadow-sm">
			<h1 class="font-display text-xl font-bold text-teal-900">Cree ton compte</h1>
			<p class="mt-1 text-[13.5px] text-[#6d8783]">Gratuit, sans carte bancaire. Prepare ton premier entretien en quelques minutes.</p>
			...
			<form class="mt-5 flex flex-col gap-3.5" on:submit|preventDefault={onSubmit}>
				...
				>
					{submitting ? 'Creation en cours...' : 'Creer un compte gratuit'}
				</button>
			</form>
		</div>
		...
		<p class="mt-5 text-center text-[13.5px] text-[#6d8783]">
			Deja un compte ?
			<a href="/login" class="font-semibold text-teal-700">Se connecter</a>
		</p>
	</div>
</div>
